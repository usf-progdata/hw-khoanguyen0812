...
Rainfall_graph_for_marriage_and_divorce <- cbind_BAp_3544_Compar_Data %>%
  ...
  theme_classic() +
  # WDG: A title is very important when it comes to graphs. Try and answer the question: "What am I looking at?" when thinking of a title. Try and be descriptive.
  labs(
